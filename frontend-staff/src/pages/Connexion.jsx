    ...
    <div className="auth-page">
      <div className="auth-card">
        <div className="auth-logo">
          ...
          <p>Encadrants & Responsables Pédagogiques</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          <div className="form-group">
            ...
            <div className="input-wrapper">
              ...
              <input {...register('email')} type="email" placeholder="votre@email.fr" className={errors.email ? 'error' : ''} />
            </div>
          ...
          <div className="form-group">
            ...
            <div className="input-wrapper">
              ...
              <input {...register('mot_de_passe')} type={showPwd ? 'text' : 'password'} placeholder="Votre mot de passe" className={errors.mot_de_passe ? 'error' : ''} />
          ...
          <button type="submit" className="btn btn-primary btn-full" disabled={loading}>
            {loading ? <div className="spinner" /> : null}{loading ? 'Connexion...' : 'Se connecter'}
          </button>
        </form>
        <div className="auth-footer">Pas encore de compte ? <Link to="/inscription">S'inscrire</Link></div>
